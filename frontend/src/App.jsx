  ...
  return (
    <Routes>
      ...
      <Route
        path='/doctor'
        element={
          <ProtectedRoute element={DoctorDashboard} allowedRoles={['doctor']} />
        }
      />
      <Route
      ...
      <Route
        path='/edit/:id'
        element={
          <ProtectedRoute element={AdminProjectPage} allowedRoles={['admin']} />
        }
      />
      <Route
        path='/create'
        element={
          <ProtectedRoute element={CreateProject} allowedRoles={['admin']} />
        }
      />

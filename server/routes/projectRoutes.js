...
router.post('/:projectId/assign-doctor', authenticate, checkAdmin, projectController.assignDoctor);

// Remove a doctor from a project
router.post('/:projectId/remove-doctor', authenticate, checkAdmin, projectController.removeDoctor);
